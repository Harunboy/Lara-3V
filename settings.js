...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "DZIkmSJC#AYsnF0Qp63zIGP1sUKtZkhSjssHh7PeL5BvUh31pXms", // Add your session id
...
STATUS_REPLY_MSG: process.env.STATUS_REPLY_MSG || "*_`Uuh_Perfect`_* 💃🏻",
